...
public class PrescriptionMaker {
    ...
    public String makePrescription(Prescription prescription, ObservableList<PrescriptionDrug> drugs, Patient patient) {
        ...
        String string = html(
                ...
                body(   h1("HOSPITAL NAME HERE").withStyle("text-align:center;font-family:ubuntu"),
                        h2("Doctor's Name: " + user.getFullName()),
                         p(
                                b(user.getInfo()),
                                br(),
                                span(phone),
                        ...
                        table().with(
                                tr().with(
                                        td().with(
                                                span("Patient's Name : " + patient.getName())
                                        ),
                                        td().with(
                                                span("Sex : " + sex)
                                        ),
                        ...
                        div(
                                p(
                                        p("This Prescription is generate with Hospital Management (Prescription Writing and patient management software). Developed by GeoCodec Technologies").withStyle("font-size:9px;"),
                                        p("Get your copy from : http://www.geocodec-technologies.com or Call 08069095729").withStyle("font-size:10px;")
                                )
